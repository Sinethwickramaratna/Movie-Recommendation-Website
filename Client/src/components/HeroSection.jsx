        ...
        <div className="relative w-full">
            <div className="relative flex min-h-[600px] flex-col items-center justify-center px-4 py-20 text-center md:px-10">
                ...
                <div className="relative z-10 flex max-w-4xl flex-col items-center gap-6 animate-fade-in-up">
                    ...
                    <h1 className="text-5xl font-black leading-tight tracking-tight text-white md:text-7xl lg:text-[5rem]">
                    ...
                    <div className="mt-4 flex w-full flex-col gap-4 sm:flex-row sm:justify-center">
                        <button className="flex h-14 items-center justify-center gap-2 rounded-xl bg-primary px-8 text-base font-bold text-background-dark transition-all hover:bg-cyan-300 hover:shadow-[0_0_20px_rgba(13,227,242,0.4)]">
                            <span className="material-symbols-outlined">smart_toy</span>
                            Get AI Recommendations
                        </button>
                        <button className="flex h-14 items-center justify-center gap-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/10 px-8 text-base font-bold text-white transition-all hover:bg-white/20">
